        ...
        CLR_RT_StackFrame &stack)
{
    ...
    // the following ones are strings so a simple assignment isn't enough, need to create a managed string instance and
    // copy over make sure the terminators are there
